...
src/shadowguy/
  ...
  app.py          Textual App: CharacterCreationScreen (start) + MainMenu + FixerListScreen/FixerOffersScreen + SceneScreen + CombatScreen + CorpMapScreen + ShopScreen + CorpHQScreen + InventoryScreen/SkillsScreen + QuitMenu/LoadMenu
```
