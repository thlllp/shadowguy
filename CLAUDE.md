...
src/shadowguy/
  ...
  corpmap.py      procedural Corp-mode territory map + ASCII renderer; Location, LocalCharacter (per-location NPCs)
  ...
  app.py          Textual App: CharacterCreationScreen (start) + MainMenu + FixerListScreen/FixerOffersScreen + SceneScreen + CombatScreen + CorpMapScreen + ShopScreen + InventoryScreen/SkillsScreen + QuitMenu/LoadMenu
```
