...
**No preset is built on the four unrolled skills** (`Armorer`, `Chemistry`, `Medicine`, `Demolitions`) — a preset that spent its 20 points on skills nothing rolls would be a trap, not an archetype. Whichever of them gets wired to a real check first is the one worth a preset.
