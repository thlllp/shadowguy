...
# v59 renamed cybernetics.py's quality tiers from numeric (Tier 1-4) to named grades
# (Deltaware/Trashware/Betaware/Alphaware): every non-Deltaware catalog id changed shape
